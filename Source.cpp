...
int main()
{
    ...
    while (check == true)
    {
        ...
        cout << "\n\n1) Enter what you want to do \n\n1For entering the Faculties data,\n2) For Showing the Faculties data"
            ...
            << "\n9) For Setting the Students Academic Info \n\nAND e for exiting the program";
        ...
        case '5':
        {
            ...
            academicRecord.set_Attandance_percentage(attandancePercentage);
            academicRecord.set_GCPA(CGPA);
            academicRecord.set_student_grades(grades);
            academicRecord.set_student_marks(marksPercentage);
